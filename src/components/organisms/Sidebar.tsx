...
const footer = (
  <div>
    &copy; 2022. Made By{" "}
    <a href="https://github.com/HU-Lee" target="_blank" rel="noreferrer">
      HU-Lee
    </a>
  </div>
);
...
function Sidebar() {
  ...
  const { lang, version, changeLang, changeVersion } =
  ...
  const path = window.location.pathname.replaceAll("/aecheck-v2", "");
    ...
    <>
      ...
      >
        <div style={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
          ...
          <Divider />
          <SideLink
            href="https://hu-lee.github.io/anotherdungeon/"
            rel="noreferrer"
            target="_blank"
          >
        ...
        <FlexColumnCenterDiv style={{ padding: 3 }}>
          ...
          <Select
            ...
            onChange={(value: string) => changeVersion(value)}
            style={{ minWidth: 100 }}
          >
